...
"""
    ...
    # 语气防火墙
    full_prompt += (
        "\n\nIMPORTANT INSTRUCTION: 下面附带的历史对话可能包含旧的“严肃风格”回复。"
...
llm = (
    ChatGoogleGenerativeAI(model="gemini-2.5-flash", temperature=0.3, timeout=30, max_retries=2)
    .bind_tools(tools)
)


def save_to_brain(source: str, content: str) -> None:
